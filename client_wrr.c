...
static int total_requests = -1;
static int server_1_weight = 100;
static int server_2_weight = 75;
static int server_3_weight = 50;

int load_balancer(){
    total_requests += 1;
    total_requests = total_requests%9;
    if(total_requests < 4){
        return 0;
    }
    else if (total_requests < 7)
    {
        return 1;
    }
    else
